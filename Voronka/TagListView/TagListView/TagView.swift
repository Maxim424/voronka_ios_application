...
open class TagView: UIButton {
    ...
    public let underlinedView = UIView()
    ...
    private func reloadStyles(withAnimation: Bool = false) {
        let changeAppearanceVBlock = { [self] in
            if isHighlighted {
    ...
    override open var isSelected: Bool {
        didSet {
            reloadStyles(withAnimation: true)
        }
    }
